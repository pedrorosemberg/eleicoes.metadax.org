...
1. **Não abra uma issue pública.** Use a aba
   ...
   canais listados em [/sobre](https://fatoeleitoral.com.br/sobre).
...
3. Como este é um projeto de código aberto mantido conforme o tempo disponível (ver
   [/participe](https://fatoeleitoral.com.br/participe)), não há um SLA formal de resposta,
...
Ver [/privacidade](https://fatoeleitoral.com.br/privacidade) para a lista completa. Resumo: sem
